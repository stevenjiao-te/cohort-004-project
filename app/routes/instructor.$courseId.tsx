      ...
      <Tabs defaultValue="content">
        <TabsList>
          ...
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-md px-2.5 py-1 text-sm font-medium whitespace-nowrap text-muted-foreground transition-[color,box-shadow] hover:text-foreground"
          >
